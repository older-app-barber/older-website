...
const links = [
  ...
  //   id: "1",
  //   title: "Perfil",
  //   description: "Suas configurações de perfil",
  //   to: "/settings/general",
  //   Icon: TbUser,
  //   color: "warning",
  // },
  ...
  return (
    <Popover className="relative">
      <PopoverButton
        ...
        size={12}
        role="button"
        src={user?.image || "/images/100x100.png"}
        alt="Profile"
        indicator={
            ...
            <>
              <div className="flex items-center gap-4 rounded-t-lg bg-gray-100 px-4 py-5 dark:bg-dark-800">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-xs text-gray-400 dark:text-dark-300">
                    {getTranslatedRole(user.role).toUpperCase()}
                  </p>
                </div>
              </div>
              <div className="flex flex-col pb-5 pt-2">
                ...
                <div className="px-4 pt-4">
                  <Button className="w-full gap-2" onClick={onLogout}>
